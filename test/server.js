...
describe('Controllers', function(){
  ...
  describe('index', function() {
    ...
    describe('POST /', function() {
      it('should get the ctrl by API req.ctrl(ctrlName)', function(done) {
        request
          .post('')
          .expect(200)
          .expect('true', done);
      ...
      it('should get the model data', function(done) {
        request
          ...
          .end(function(err, res) {
            res.body.should.eql(ovenware.models.items.index());
            done(err);
          });
      });
    });
      ...
      describe('POST /', function() {
        it('should get the data by API exports.model()', function(done) {
          request
            ...
            .expect(200)
            .end(function(err, res) {
              res.body.should.eql(ovenware.models['users/oauth'].index());
              done(err);
            });
        });
      });
